...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <form id="reporteForm" action="../controllers/guardar_reporte.php" method="POST" enctype="multipart/form-data" class="mt-4">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descripcion" name="descripcion" rows="4" placeholder="Incluye lugar, fecha, hora, etc." required></textarea>
            </div>
            <div class="mb-3">
